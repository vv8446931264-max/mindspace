    ...
    <section aria-label="Wellness insights" className="space-y-5">
      ...
      >
        {appState.status === "idle" && (
          <div className="rounded-3xl bg-white/80 backdrop-blur border border-white shadow-[0_8px_30px_rgba(91,141,239,0.08)] p-8 text-center">
            <div
              className="mx-auto mb-4 grid place-items-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-50 to-emerald-50 text-4xl"
              aria-hidden="true"
            >
              🌱
            </div>
      ...
      <div className="rounded-3xl bg-white/80 backdrop-blur border border-white shadow-[0_8px_30px_rgba(91,141,239,0.08)] p-5">
        <MoodChart history={moodHistory} />
      </div>

      <div className="rounded-2xl bg-white/60 backdrop-blur border border-white/80 p-4">
        ...
        <div className="flex flex-wrap gap-2">
          <a
            href="tel:9152987821"
            className="text-xs text-slate-600 bg-white border border-slate-100 px-3 py-1.5 rounded-full hover:border-[#5B8DEF] hover:text-[#5B8DEF] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#5B8DEF]"
            aria-label="Call iCall helpline at 9152987821"
          >
            📞 iCall <strong className="font-bold">9152987821</strong>
          </a>
          <a
          ...
          >
            📞 Vandrevala <strong className="font-bold">1860-2662-345</strong>
          </a>
        </div>
      </div>
    </section>
